...
- Explore the [reference guide](formatting-reference/index.md) for markdown features
...
3. **Explore features** - [Formatting Reference](formatting-reference/index.md)
...
- **Formatting Reference**: [Formatting Reference](formatting-reference/index.md)
